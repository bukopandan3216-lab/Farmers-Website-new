...
const productNames = [
  ...
  ['Corn', 'Grains', 'https://images.unsplash.com/photo-1551754655-cd27e38d2076-30c4db37cd89?w=900&q=80'], ['Peanuts', 'Grains', 'https://images.unsplash.com/photo-1567892737950-30c4db37cd89?w=900&q=80'],
  ['Native Chicken', 'Poultry', 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7b?w=900&q=80'], ['Kesong Puti', 'Dairy', 'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=900&q=80'],
  ...
  ['Garlic', 'Vegetables', 'https://images.unsplash.com/photo-1540148426945-6cf22b6b2383?w=900&q=80'], ['Avocado', 'Fruits', 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=900&q=80'],
] as const;
...
export async function seedDatabase() {
  ...
  for (let i = 0; i < 12; i += 1) {
    ...
    const total = orderProducts.reduce((sum, product, idx) => sum + Number(product.price) * (idx + 1), 0);
...
export async function ensureDemoUsers() {
  ...
  const usersToCheck = [
    ...
    },
    {
      ...
      data: {
        ...
        passwordHash,
        role: 'FARMER',
        phone: '+63 917 000 100',
        farmerProfile: {
          create: {
            farmName: 'Sunrise Demo Farm',
            farmDescription: 'Demo farmer account created for development',
            farmLocation: 'Metro Manila',
            verified: true,
            coverImage: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1200&q=80',
          },
        },
  ...
  for (const userInfo of usersToCheck) {
    ...
    if (!existing) {
      await prisma.user.create({ data: userInfo.data as any });
      console.log(`Created missing demo user: ${userInfo.email}`);
    }
  }
}
