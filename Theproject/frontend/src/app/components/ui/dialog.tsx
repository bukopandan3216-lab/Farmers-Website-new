...
function DialogPortal({ ...props }: React.ComponentProps<typeof DialogPrimitive.Portal>) {
  // Radix Portal does not accept a DOM ref the same way other primitives do.
  // Return the Portal without attempting to forward a ref to avoid TypeScript/ref mismatches.
